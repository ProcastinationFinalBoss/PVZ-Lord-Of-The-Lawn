...
enum BackgroundType
{
    ...
    BACKGROUND_1_DAYEVENING,
    BACKGROUND_2_NIGHTEVENING,
    BACKGROUND_5_ROOFEVENING,
};
enum BoardResult
{
    BOARDRESULT_NONE = 0,
...
enum GameMode
{
    ...
    GAMEMODE_UPSELL,
    GAMEMODE_INTRO,
    GAMEMODE_CHALLENGE_LOCAL_WARMING,
    NUM_GAME_MODES
};
enum GameObjectType
{
...
enum SeedType
{
    ...
    ENUM_AUTO_VALUE(SEED_BONKCHOY)                  
    ENUM_AUTO_VALUE(SEED_CHILLPEAR)                  
    ENUM_AUTO_VALUE(SEED_SUNBEAN)                  
    ENUM_AUTO_VALUE(SEED_SAKURA)                  
    ENUM_AUTO_VALUE(SEED_SPORESHROOM)                  
    ENUM_AUTO_VALUE(SEED_ACIDLEMON)                  
    ENUM_AUTO_VALUE(SEED_STINGER)                  
...
enum StoreItem
{
    ...
    STORE_ITEM_PLANT_LASERBEAN,
    STORE_ITEM_PLANT_BONKCHOY,
    STORE_ITEM_PLANT_CHILLPEAR,
    STORE_ITEM_PLANT_SUNBEAN,
    STORE_ITEM_PLANT_SAKURA,
    STORE_ITEM_PLANT_SPORESHROOM,
