...
Image* Sexy::IMAGE_PROJECTILESPORE;
...
bool Sexy::ExtractLoadingImagesResources(ResourceManager *theManager)
{
	...
	try
	{
		...
		IMAGE_LASERGLOW = aMgr.GetImageThrow("IMAGE_LASERGLOW");
		...
		IMAGE_PROJECTILESPORE = aMgr.GetImageThrow("IMAGE_PROJECTILESPORE");
...
const char* Sexy::GetStringIdById(int theId)
{
	switch(theId)
	{
		...
		case IMAGE_LASERGLOW_ID: return "IMAGE_LASERGLOW";
		...
		case IMAGE_PROJECTILESPORE_ID: return "IMAGE_PROJECTILESPORE";
