...
#include <algorithm>
//int gPlantSides[SeedType::NUM_SEED_TYPES] = { 0 };

const int kPlantAlmanacStatAllSides = -1;
std::vector<PlantAlmanacStat> gPlantAlmanacStats[SeedType::NUM_SEED_TYPES];

int GetPlantAlmanacStatSideMaskForSide(int theSide)
{
    TOD_ASSERT(theSide >= 0);
    return 1 << theSide;
}

static bool PlantAlmanacStatIsVisibleOnSide(const PlantAlmanacStat& theStat, int theSide)
{
    return theStat.mSideMask == kPlantAlmanacStatAllSides || (theStat.mSideMask & (1 << theSide)) != 0;
}

static void InitializePlantAlmanacStats()
{
    static bool gPlantAlmanacStatsInitialized = false;
    if (gPlantAlmanacStatsInitialized)
        return;

    gPlantAlmanacStatsInitialized = true;
    gPlantAlmanacStats[SeedType::SEED_PEASHOOTER].push_back({ _S("Damage"), _S("20"), kPlantAlmanacStatAllSides });
    gPlantAlmanacStats[SeedType::SEED_PEASHOOTER].push_back({ _S("Fire Rate"), _S("1.5s"), kPlantAlmanacStatAllSides });
    gPlantAlmanacStats[SeedType::SEED_PEASHOOTER].push_back({ _S("Range"), _S("Straight, Long"), kPlantAlmanacStatAllSides });

    gPlantAlmanacStats[SeedType::SEED_REPEATER].push_back({ _S("Damage"), _S("20 x 2"), kPlantAlmanacStatAllSides });
    gPlantAlmanacStats[SeedType::SEED_REPEATER].push_back({ _S("Fire Rate"), _S("1.5s"), kPlantAlmanacStatAllSides });
    gPlantAlmanacStats[SeedType::SEED_REPEATER].push_back({ _S("Range"), _S("Straight, Long"), kPlantAlmanacStatAllSides });

    gPlantAlmanacStats[SeedType::SEED_SNOWPEA].push_back({ _S("Damage"), _S("20"), kPlantAlmanacStatAllSides });
    gPlantAlmanacStats[SeedType::SEED_SNOWPEA].push_back({ _S("Fire Rate"), _S("2.25s"), kPlantAlmanacStatAllSides });
    gPlantAlmanacStats[SeedType::SEED_SNOWPEA].push_back({ _S("Range"), _S("Straight, Long"), kPlantAlmanacStatAllSides });

    gPlantAlmanacStats[SeedType::SEED_GATLINGPEA].push_back({ _S("Damage"), _S("20 x 4"), kPlantAlmanacStatAllSides });
    gPlantAlmanacStats[SeedType::SEED_GATLINGPEA].push_back({ _S("Fire Rate"), _S("1.5s"), kPlantAlmanacStatAllSides });
    gPlantAlmanacStats[SeedType::SEED_GATLINGPEA].push_back({ _S("Range"), _S("Straight, Long"), kPlantAlmanacStatAllSides });

    gPlantAlmanacStats[SeedType::SEED_THREEPEATER].push_back({ _S("Damage"), _S("20 x 3"), kPlantAlmanacStatAllSides });
    gPlantAlmanacStats[SeedType::SEED_THREEPEATER].push_back({ _S("Fire Rate"), _S("1.5s"), kPlantAlmanacStatAllSides });
    gPlantAlmanacStats[SeedType::SEED_THREEPEATER].push_back({ _S("Range"), _S("Straight, 3 Lanes"), kPlantAlmanacStatAllSides });

    gPlantAlmanacStats[SeedType::SEED_SPLITPEA].push_back({ _S("Damage"), _S("20 x 3"), kPlantAlmanacStatAllSides });
    gPlantAlmanacStats[SeedType::SEED_SPLITPEA].push_back({ _S("Fire Rate"), _S("1.5s"), kPlantAlmanacStatAllSides });
    gPlantAlmanacStats[SeedType::SEED_SPLITPEA].push_back({ _S("Range"), _S("Straight, Both Directions"), kPlantAlmanacStatAllSides });

    gPlantAlmanacStats[SeedType::SEED_SCAREDYSHROOM].push_back({ _S("Range"), _S("Straight, Long"), kPlantAlmanacStatAllSides });
    gPlantAlmanacStats[SeedType::SEED_PUFFSHROOM].push_back({ _S("Range"), _S("Straight, 3 Tiles Ahead"), kPlantAlmanacStatAllSides });

    gPlantAlmanacStats[SeedType::SEED_GRAVEBUSTER].push_back({ _S("Grave Removal Time"), _S("5s"), GetPlantAlmanacStatSideMaskForSide(0) });
    gPlantAlmanacStats[SeedType::SEED_GRAVEBUSTER].push_back({ _S("Activation Time"), _S("5s"), GetPlantAlmanacStatSideMaskForSide(1) });
    //gPlantAlmanacStats[SeedType::SEED_GRAVEBUSTER].push_back({ _S("Fire Rate"), _S("1.5s"), GetPlantAlmanacStatSideMaskForSide(0) });

    gPlantAlmanacStats[SeedType::SEED_FUMESHROOM].push_back({ _S("Damage"), _S("20"), GetPlantAlmanacStatSideMaskForSide(0) });
    gPlantAlmanacStats[SeedType::SEED_FUMESHROOM].push_back({ _S("Damage"), _S("40"), GetPlantAlmanacStatSideMaskForSide(1) });
    gPlantAlmanacStats[SeedType::SEED_FUMESHROOM].push_back({ _S("Fire Rate"), _S("1.5s"), GetPlantAlmanacStatSideMaskForSide(0) });
    gPlantAlmanacStats[SeedType::SEED_FUMESHROOM].push_back({ _S("Fire Rate"), _S("1.25s"), GetPlantAlmanacStatSideMaskForSide(1) });
    gPlantAlmanacStats[SeedType::SEED_FUMESHROOM].push_back({ _S("Range"), _S("4 Tiles Ahead"), GetPlantAlmanacStatSideMaskForSide(0) });
    gPlantAlmanacStats[SeedType::SEED_FUMESHROOM].push_back({ _S("Range"), _S("1 Tile Ahead"), GetPlantAlmanacStatSideMaskForSide(1) });
    gPlantAlmanacStats[SeedType::SEED_FUMESHROOM].push_back({ _S("Knockback Chance"), _S("25%"), GetPlantAlmanacStatSideMaskForSide(1) });

    gPlantAlmanacStats[SeedType::SEED_CHOMPER].push_back({ _S("Range"), _S("1 Tile Ahead"), GetPlantAlmanacStatSideMaskForSide(0) | GetPlantAlmanacStatSideMaskForSide(2) });
    gPlantAlmanacStats[SeedType::SEED_CHOMPER].push_back({ _S("Range"), _S("2 Tiles Ahead"), GetPlantAlmanacStatSideMaskForSide(1) });
    gPlantAlmanacStats[SeedType::SEED_CHOMPER].push_back({ _S("Bite Damage"), _S("100-150 (vs. armored)"), GetPlantAlmanacStatSideMaskForSide(1) });
    gPlantAlmanacStats[SeedType::SEED_CHOMPER].push_back({ _S("Bite Damage"), _S("40"), GetPlantAlmanacStatSideMaskForSide(0) | GetPlantAlmanacStatSideMaskForSide(2)   });
    gPlantAlmanacStats[SeedType::SEED_CHOMPER].push_back({ _S("Chewing Cooldown"), _S("40s"), GetPlantAlmanacStatSideMaskForSide(0) });
    gPlantAlmanacStats[SeedType::SEED_CHOMPER].push_back({ _S("Chewing Cooldown"), _S("25s"), GetPlantAlmanacStatSideMaskForSide(1) });
    gPlantAlmanacStats[SeedType::SEED_CHOMPER].push_back({ _S("Damage Threshold"), _S("1000"), GetPlantAlmanacStatSideMaskForSide(1) });
    gPlantAlmanacStats[SeedType::SEED_CHOMPER].push_back({ _S("Chewing Cooldown"), _S("15-30-60s"), GetPlantAlmanacStatSideMaskForSide(2) });

    gPlantAlmanacStats[SeedType::SEED_SQUASH].push_back({ _S("Smash Damage"), _S("1800"), GetPlantAlmanacStatSideMaskForSide(0) });
    gPlantAlmanacStats[SeedType::SEED_SQUASH].push_back({ _S("Smash Damage"), _S("80"), GetPlantAlmanacStatSideMaskForSide(1) });
...
const std::vector<PlantAlmanacStat>& GetPlantAlmanacStats(SeedType theSeedType)
{
    ...
    InitializePlantAlmanacStats();
    return gPlantAlmanacStats[theSeedType];
}
...
std::vector<PlantAlmanacStat> GetVisiblePlantAlmanacStats(SeedType theSeedType)
{
    ...
    std::vector<PlantAlmanacStat> aVisibleStats;
    int aCurrentSide = GetPlantSide(theSeedType);
    for (const PlantAlmanacStat& aStat : gPlantAlmanacStats[theSeedType])
    {
        if (PlantAlmanacStatIsVisibleOnSide(aStat, aCurrentSide))
            aVisibleStats.push_back(aStat);
    }

    return aVisibleStats;
}

void AddPlantAlmanacStat(SeedType theSeedType, const SexyString& theLabel, const SexyString& theValue, int theSideMask)
{
    TOD_ASSERT(theSeedType >= 0 && theSeedType < SeedType::NUM_SEED_TYPES);
    InitializePlantAlmanacStats();

    gPlantAlmanacStats[theSeedType].push_back({ theLabel, theValue, theSideMask });
}

void DeletePlantAlmanacStat(SeedType theSeedType, const SexyString& theLabel, const SexyString& theValue, int theSideMask)
{
    TOD_ASSERT(theSeedType >= 0 && theSeedType < SeedType::NUM_SEED_TYPES);
    InitializePlantAlmanacStats();

    std::vector<PlantAlmanacStat>& aStats = gPlantAlmanacStats[theSeedType];
    aStats.erase(std::remove_if(aStats.begin(), aStats.end(), [&](const PlantAlmanacStat& aStat)
        {
            return aStat.mLabel == theLabel && aStat.mValue == theValue && aStat.mSideMask == theSideMask;
        }), aStats.end());
}
void ResetPlantSides()
{
    ...
    {
        for (int i = 0; i < SeedType::NUM_SEED_TYPES; i++)
            gLawnApp->mPlayerInfo->mPlantSides[i] = 0;
    }
}
...
{
    TOD_ASSERT(theSeedType >= 0 && theSeedType < SeedType::NUM_SEED_TYPES);
    //gPlantSides[theSeedType] = theValue;
    if (gLawnApp && gLawnApp->mPlayerInfo)
    {
        gLawnApp->mPlayerInfo->mPlantSides[theSeedType] = theValue;
    }
}
...
int GetPlantSide(SeedType theSeedType)
{
    ...
    if (gLawnApp && gLawnApp->mBoard && gLawnApp->mGameScene == GameScenes::SCENE_PLAYING)
        return gLawnApp->mBoard->mPlantSides[theSeedType];

    //return gPlantSides[theSeedType];
    if (gLawnApp && gLawnApp->mPlayerInfo)
        return gLawnApp->mPlayerInfo->mPlantSides[theSeedType];

    return 0;
}
//int GetImitaterSide(SeedType theImitaterType)
//{
//    if (theImitaterType >= SeedType::NUM_SEED_TYPES)
//        return 0;
//    TOD_ASSERT(theImitaterType >= 0 && theImitaterType < SeedType::NUM_SEED_TYPES);
//    if (gLawnApp && gLawnApp->mBoard && gLawnApp->mGameScene == GameScenes::SCENE_PLAYING)
//        return gLawnApp->mBoard->mPlantSides[theImitaterType];
//
//    return gPlantSides[theImitaterType];
//}

int gPlantMaxSides[SeedType::NUM_SEED_TYPES] = { 0 };

static void InitializePlantMaxSides()
{
    static bool gPlantMaxSidesInitialized = false;
    if (gPlantMaxSidesInitialized)
        return;

    for (int i = 0; i < (int)SeedType::NUM_SEED_TYPES; i++)
        gPlantMaxSides[i] = 2;

    gPlantMaxSides[SeedType::SEED_PEASHOOTER] = 3;
    gPlantMaxSides[SeedType::SEED_PUFFSHROOM] = 3;
    gPlantMaxSides[SeedType::SEED_CHOMPER] = 3;

    gPlantMaxSidesInitialized = true;
}
...
int GetPlantMaxSides(SeedType theSeedType)
{
    ...
    InitializePlantMaxSides();
    return gPlantMaxSides[theSeedType];
}
...
void SetPlantMaxSides(SeedType theSeedType, int theValue)
{
    ...
    InitializePlantMaxSides();
    gPlantMaxSides[theSeedType] = theValue;
}
...
PlantDefinition gPlantDefs[SeedType::NUM_SEED_TYPES] = {  
    ...
    { SeedType::SEED_SNOWPEA,           nullptr, ReanimationType::REANIM_SNOWPEA,       4,  250,    750,    PlantSubClass::SUBCLASS_SHOOTER,    225,    _S("SNOW_PEA") },
    ...
    { SeedType::SEED_SEASHROOM,         nullptr, ReanimationType::REANIM_GOLDBLOOM,     39, 75,      7000,   PlantSubClass::SUBCLASS_NORMAL,    150,    _S("SEA_SHROOM") },
    { SeedType::SEED_PLANTERN,          nullptr, ReanimationType::REANIM_PLANTERN,      38, 25,     3000,   PlantSubClass::SUBCLASS_NORMAL,     2500,   _S("PLANTERN") },
    { SeedType::SEED_CACTUS,            nullptr, ReanimationType::REANIM_CACTUS,        15, 200,    750,    PlantSubClass::SUBCLASS_SHOOTER,    200,    _S("CACTUS") },
    { SeedType::SEED_BLOVER,            nullptr, ReanimationType::REANIM_BLOVER,        18, 75,    0,    PlantSubClass::SUBCLASS_NORMAL,     0,      _S("BLOVER") },
    { SeedType::SEED_SPLITPEA,          nullptr, ReanimationType::REANIM_SPLITPEA,      32, 250,    1500,    PlantSubClass::SUBCLASS_SHOOTER,    150,    _S("SPLIT_PEA") },
    ...
    { SeedType::SEED_GARLIC,            nullptr, ReanimationType::REANIM_GARLIC,        8,  125,     750,    PlantSubClass::SUBCLASS_NORMAL,     0,      _S("GARLIC") },
...
void Plant::PlantInitialize(int theGridX, int theGridY, SeedType theSeedType, SeedType theImitaterType)
{
    ...
    mThreePeaRowLesserOffset = 0;

    if (theSeedType == SeedType::SEED_IMITATER && theImitaterType != SeedType::SEED_NONE)
    {
        mSide = GetPlantSide(theImitaterType);
    }
    else
    {
        mSide = GetPlantSide(theSeedType);
    }
    ...
    if (aPlantDef.mReanimationType != ReanimationType::REANIM_NONE)
    {
        ...
        if ((mApp->IsWallnutBowlingLevel() || (mSeedType == SeedType::SEED_WALLNUT && mSide == 1)) && aBodyReanim->TrackExists("_ground"))
        {
    ...
    case SeedType::SEED_GARLIC:
        TOD_ASSERT(aBodyReanim);
        mPlantHealth = 400;
        mState = PlantState::STATE_GARLIC_AURA;
        ...
        {
            TodParticleSystem* aParticleSystem = AddAttachedParticle(mX + 40, mY + 40, (int)RenderLayer::RENDER_LAYER_FOG + 1, ParticleEffect::PARTICLE_LANTERN_SHINE);
            aParticleSystem->OverrideScale(nullptr, 0.75f);
            aParticleSystem->OverrideColor(nullptr, Color(175,255,175));
        }
        break;
    ...
    case SeedType::SEED_SAKURA:
        mState = PlantState::STATE_SAKURA_PREPARE;
        mStateCountdown = 100;
        //mBlinkCountdown = 1000 + Sexy::Rand(1000);
...
int Plant::CalcRenderOrder()
{
    ...
    if (mApp->IsWallnutBowlingLevel() || (mSeedType == SeedType::SEED_WALLNUT && mSide == 1))
    {
...
void Plant::DoRowAreaDamage(int theDamage, unsigned int theDamageFlags)
{
    ...
    Zombie* aZombieFume = nullptr;

    bool aRNG = Rand(4) == 0;
    int aFumeCount = 0;
    if (mSeedType == SeedType::SEED_FUMESHROOM && mSide == 1 && aRNG)
    {
        while (mBoard->IterateZombies(aZombieFume))
        {
            int aDiffY = (aZombieFume->mZombieType == ZombieType::ZOMBIE_BOSS) ? 0 : (aZombieFume->mRow - mRow);
            if (aDiffY)
                continue;

            if (aZombieFume->mOnHighGround == IsOnHighGround() && aZombieFume->EffectedByDamage(aDamageRangeFlags))
            {
                Rect aZombieRect = aZombieFume->GetZombieRect();
                if (GetRectOverlap(aAttackRect, aZombieRect) > 0)
                {
                    aFumeCount++;
                    aFumeCount = ClampInt(aFumeCount, 0, 5);
                }
            }
        }
    }
    ...
    while (mBoard->IterateZombies(aZombie))
    {
        ...
        if (aZombie->mOnHighGround == IsOnHighGround() && aZombie->EffectedByDamage(aDamageRangeFlags))
        {
            ...
            if (GetRectOverlap(aAttackRect, aZombieRect) > 0)
            {
                ...
                if (mSeedType == SeedType::SEED_FUMESHROOM && mSide == 1 && aRNG)
                {
                    int aDuration = 18 - ((aFumeCount - 1) * 2.25f);
                    aZombie->KnockBackZombie(1, 3.0f, aDuration);
                    aZombie->ApplyStun(aDuration);
                }
...
bool Plant::FindTargetAndFire(int theRow, PlantWeapon thePlantWeapon)
{
    ...
    {
        PlayBodyReanim("anim_shooting", ReanimLoopType::REANIM_PLAY_ONCE_AND_HOLD, 20, 20.0f);
        mShootingCounter = 100;
    }
...
void Plant::LaunchThreepeater()
{
    ...
    if ((FindTargetZombie(mRow, PlantWeapon::WEAPON_PRIMARY) || FindTargetGridItem(mRow, PlantWeapon::WEAPON_PRIMARY) != nullptr) ||
        (mBoard->RowCanHaveZombies(rowAbove) && (FindTargetZombie(rowAbove, PlantWeapon::WEAPON_PRIMARY) != nullptr || FindTargetGridItem(rowAbove, PlantWeapon::WEAPON_PRIMARY) != nullptr)) ||
        (mBoard->RowCanHaveZombies(rowBelow) && (FindTargetZombie(rowBelow, PlantWeapon::WEAPON_PRIMARY) != nullptr || FindTargetGridItem(rowBelow, PlantWeapon::WEAPON_PRIMARY) != nullptr)))
    {
        bool hasRowAbove = mBoard->RowCanHaveZombies(rowAbove) && (FindTargetZombie(rowAbove, PlantWeapon::WEAPON_PRIMARY) != nullptr || FindTargetGridItem(rowAbove, PlantWeapon::WEAPON_PRIMARY) != nullptr);
        bool hasRowCenter = FindTargetZombie(mRow, PlantWeapon::WEAPON_PRIMARY) != nullptr || FindTargetGridItem(mRow, PlantWeapon::WEAPON_PRIMARY) != nullptr;
        bool hasRowBelow = mBoard->RowCanHaveZombies(rowBelow) && (FindTargetZombie(rowBelow, PlantWeapon::WEAPON_PRIMARY) != nullptr || FindTargetGridItem(rowBelow, PlantWeapon::WEAPON_PRIMARY) != nullptr);
...
bool Plant::FindStarFruitTarget()
{
    ...
    {
        Rect aGridItemRect = aGridItem->GetPVZ2GraveRect();
        if (!TestBit(GetDamageRangeFlags(), (int)DamageRangeFlags::DAMAGES_FLYING)) {
            if (aGridItem->mGridY == mRow)
            {
                if (aGridItemRect.mX + aGridItemRect.mWidth < aCenterStarX)
                    return true;
            }
            else
            {
                float aProjectileTime = Distance2D(aCenterStarX, aCenterStarY, aGridItemRect.mX + aGridItemRect.mWidth / 2, aGridItemRect.mY + aGridItemRect.mHeight / 2) / 3.33f;
                int aGridItemHitX = aGridItemRect.mX;
                if ((aGridItemHitX + aGridItemRect.mWidth > aCenterStarX) && (aGridItemHitX < aCenterStarX))
                    return true;

                int aCenterGridItemX = aGridItemRect.mX + aGridItemRect.mWidth / 2;
                int aCenterGridItemY = aGridItemRect.mY + aGridItemRect.mHeight / 2;
                float angle = RAD_TO_DEG(atan2(aCenterGridItemY - aCenterStarY, aCenterGridItemX - aCenterStarX));
...
void Plant::SakuraFire()
{
    ...
    {
        float aDirection = i * 60;
        float aPositionX = -2.0f * cos(DEG_TO_RAD(aDirection));
        float aPositionY = 2.0f * -sin(DEG_TO_RAD(aDirection));
        Projectile* aProjectile = mBoard->AddProjectile(mX + 20, mY + 20, mRenderOrder - 1, mRow, ProjectileType::PROJECTILE_SAKURA);
        aProjectile->mMagnetDegree = i * 60;
        aProjectile->mDamageRangeFlags = GetDamageRangeFlags(PlantWeapon::WEAPON_PRIMARY);
        aProjectile->mMotionType = ProjectileMotion::MOTION_ORBIT;
        aProjectile->mPlantOwnerID = (PlantID)mBoard->mPlants.DataArrayGetID(this);
        aProjectile->mVelX = aPositionX;
        aProjectile->mVelY = aPositionY;
        aProjectile->mOriginalX = mX + 20;
        aProjectile->mOriginalY = mY + 20;
    }
}
...
void Plant::UpdateShooter()
{
    ...
    if (mLaunchCounter <= 0)
    {
        ...
        //else if (
        //    mSeedType == SeedType::SEED_SLINGPEA
        //    )
        //{
        //    int maxRows = mBoard->StageHas6Rows() ? 6 : 5;
        //    int shootCounter = maxRows;
        ...
        else if (mSeedType == SeedType::SEED_SLINGPEA)
        {
            ...
            {
                if (FindTargetZombie(r, PlantWeapon::WEAPON_PRIMARY) != nullptr)
                {
                    aHasTarget = true;
                    break;
                }
...
void Plant::UpdateGraveBuster()
{
    ...
    else if (mState == PlantState::STATE_GRAVEBUSTER_EATING && mStateCountdown == 0)
    {
        if (mSide == 1)
        {
            ...
            //        //aParticleSystem->OverrideScale(nullptr, 1.0f);
...
void Plant::UpdatePotato()
{
    ...
    if (mSide == 1)
    {
        ...
        while (mBoard->IterateZombies(aZombie))
        {
            ...
            if (aZombie->mZombiePhase == ZombiePhase::PHASE_DIGGER_TUNNELING ||
                ...
                aZombie->mZombiePhase == ZombiePhase::PHASE_BALLOON_FLYING ||
                aZombie->mZombiePhase == ZombiePhase::PHASE_IMP_GETTING_THROWN ||
            ...
            //    aZombie->mZombieType == ZombieType::ZOMBIE_REDEYE_GARGANTUAR
            //    )
            //    aZombieRect = aZombie->GetBasicRect();
            if (GetRectOverlap(aAttackRect, aZombieRect) > 0)
            {
                if (!(aZombie->mPlantAttractedID && mBoard->mPlants.DataArrayTryToGet((unsigned int)aZombie->mPlantAttractedID)))
                {
                    aZombie->mPlantAttractedID = (PlantID)mBoard->mPlants.DataArrayGetID(this);
                }
                else if (aZombie->mPlantAttractedID && mBoard->mPlants.DataArrayTryToGet((unsigned int)aZombie->mPlantAttractedID))
                {
                    if ((mBoard->mPlants.DataArrayTryToGet((unsigned int)aZombie->mPlantAttractedID))->mSquished)
                        aZombie->mPlantAttractedID = (PlantID)mBoard->mPlants.DataArrayGetID(this);
                }
                if (aZombie->mPlantAttractedID && aZombie->mPlantAttractedID == (PlantID)mBoard->mPlants.DataArrayGetID(this))
                {
                    if (aRowDeviation != 0)
                    {
                        aZombie->SetRow(mRow);
                    }
                    int aPlantCenterX = mX + mWidth / 2;
                    int aZombieCenterX = aZombie->mX + aZombie->mWidth / 2;
                    int aAttractStopBuffer = 20;
                    if (aZombieCenterX < aPlantCenterX - aAttractStopBuffer)
                    {
    ...
    {
        if (FindTargetZombie(mRow, PlantWeapon::WEAPON_PRIMARY) || mSide == 1)
        {
            DoSpecial();
        }
        else
...
void Plant::UpdateHypnoShroom()
{
    ...
    else if (mState == PlantState::STATE_READY)
    {
        ...
        if (!mBoard->ZombieTryToGet(mTargetZombieID))
        {
            Zombie* aZombie = GetRandomZombie(SeedType::SEED_HYPNOSHROOM);
    ...
    while (mBoard->IterateZombies(aZombie))
    {
        if ((aZombie->mRow == mRow || aZombie->mZombieType == ZombieType::ZOMBIE_BOSS) && aZombie->EffectedByDamage(aDamageRangeFlags))
        {
            ...
            if (GetRectOverlap(aAttackRect, aZombieRect) > (aZombie->mZombieType == ZombieType::ZOMBIE_FOOTBALL ? -20 : 0))
            {
                if (mSide == 1)
                {
                    aZombie->TakeDamage(80, 0U);
                    aZombie->ApplyStun(125);
                }
                else
                {
    ...
    while (mBoard->IterateZombies(aZombie))
    {
            ...
            aZombie->mHasHead && !aZombie->IsTangleKelpTarget() && aZombie->EffectedByDamage(aDamageRangeFlags))
        {
                ...
                ))
            {
                ...
                if (aRange <= (aZombie->mIsEating ? 110 : mSide == 1 ? 35 : 70))
                {
...
void Plant::UpdateSquash()
{
    ...
    if (mState == PlantState::STATE_NOTREADY)
    {
        ...
        if (aZombie)
        {
            ...
            if (mSide == 1)
            {
                mApp->PlayFoleyPitch(FoleyType::FOLEY_SQUASH_HMM, 15.0f);
            }
            else
            {
        ...
        else if (mState == PlantState::STATE_SQUASH_FALLING)
        {
            ...
            if (mStateCountdown == 0)
            {
                ...
                else
                {
                    ...
                    if (mSide == 1)
                    {
                        mApp->PlayFoleyPitch(FoleyType::FOLEY_SPLAT, -5.0f);
                        TodParticleSystem* aParticleSystem = mApp->AddTodParticle(mX + 40, mY + aOffsetY, mRenderOrder + 4, ParticleEffect::PARTICLE_DUST_SQUASH);
                        aParticleSystem->OverrideScale(nullptr, 0.25f);
                    }
                    else
                    {
...
void Plant::UpdateGoldBloom()
{
    if (mState == PlantState::STATE_DOINGSPECIAL && mStateCountdown <= 0)
    {
        if (mBonkChoyPunchCD > 0.0f)
        {
            mBoard->AddCoin(mX - 25, mY - 20, CoinType::COIN_LARGESUN, CoinMotion::COIN_MOTION_FROM_PLANT);
            mBoard->AddCoin(mX + 25, mY - 20, CoinType::COIN_LARGESUN, CoinMotion::COIN_MOTION_FROM_PLANT);
            mBonkChoyPunchCD -= 1.0f;
            mStateCountdown = 100;
            mEatenFlashCountdown = 75;
        }
    }
}
void Plant::UpdateSakura()
{
    Reanimation* aBodyReanim = mApp->ReanimationTryToGet(mBodyReanimID);
    float aAnimProgress = aBodyReanim->mAnimTime;
    int aFrameAtImpact = (int)(aBodyReanim->mFrameCount * 0.5f);
    int aCurrentFrame = (int)(aAnimProgress * aBodyReanim->mFrameCount);
    if (mState == PlantState::STATE_SAKURA_READY)
    {
        if (mStateCountdown <= 0)
        {
            mState = PlantState::STATE_SAKURA_FIRE;
            PlayBodyReanim("anim_shooting", ReanimLoopType::REANIM_LOOP, 20, 16.0f);
            mStateCountdown = 150;
            Projectile* aProjectile = nullptr;
            while (mBoard->IterateProjectiles(aProjectile))
            {
                if (aProjectile->mPlantOwnerID == (PlantID)mBoard->mPlants.DataArrayGetID(this))
                {
                    aProjectile->mPlantOwnerID = PlantID::PLANTID_NULL;
                    aProjectile->mVelX = -6.66f * cos(DEG_TO_RAD(aProjectile->mMagnetDegree));
                    aProjectile->mVelY = 6.66f * -sin(DEG_TO_RAD(aProjectile->mMagnetDegree));
                }
            }
        }
    }
    else if (mState == PlantState::STATE_SAKURA_LAUNCH)
    {
        if (aBodyReanim->mLoopCount > 0)
        {
            PlayIdleAnim(aBodyReanim->mDefinition->mFPS);
            mState = PlantState::STATE_SAKURA_NOTREADY;
            mStateCountdown = 500;
        }
    }
    else if (mState == PlantState::STATE_SAKURA_FIRE)
    {
        Reanimation* aBodyReanim = mApp->ReanimationGet(mBodyReanimID);
...
void Plant::UpdateGarlic()
{
    if (mState == PlantState::STATE_GARLIC_AURA)
    {
        if (mStateCountdown > 0)
        {
            Rect aAttackRect = GetPlantAttackRect(PlantWeapon::WEAPON_PRIMARY);
            ...
            while (mBoard->IterateZombies(aZombie))
            {
                ...
                if (GetRectOverlap(aAttackRect, aZombieRect) > 0)
                {
                    if (!aZombie->mYuckyFace && aRowDeviation == 0 )
                    {
                        aZombie->mYuckyFace = true;
                        aZombie->mYuckyFaceCounter = 0;
                        aZombie->UpdateAnimSpeed();
                    }
                    else if (!aZombie->mYuckyFace && aRowDeviation != 0)
                    {
                        aZombie->mSlowCounter = max(1000, aZombie->mSlowCounter);
                    }
                }
            }
        }
...
void Plant::UpdatePuffShroom()
{
    if (mStateCountdown > 0 && mStateCountdown <= 800)
    {
        float aProgress = pow(1.0f - (mStateCountdown / 1000.0f), 2);

        float aMinSpeed = 0.08f; 
        float aMaxSpeed = 0.4f; 

        float aCurSpeed = aMinSpeed + (aProgress * (aMaxSpeed - aMinSpeed));

        mBonkChoyPunchCD += aCurSpeed;


        if (sin(mBonkChoyPunchCD) > 0)
        {
    ...
    if (mStateCountdown <= 0)
    {
        TodParticleSystem* aParticleSystem = mApp->AddTodParticle(mX + 40, mY + 50, (int)RenderLayer::RENDER_LAYER_TOP, ParticleEffect::PARTICLE_IMITATER_MORPH);
        aParticleSystem->OverrideScale(nullptr, 0.75f);
        Die();
    }
...
void Plant::UpdateBonkchoy()
{
    ...
    if (mState == PlantState::STATE_READY) {
        ...
        {
            mStateCountdown = mBonkChoyPunchCD;
            if (aGridItem->GetPVZ2GraveRect().mX < GetPlantRect().mX)
            {
                mBonkchoyFlipped = true;
            }
            else
    ...
    else if (mState == PlantState::STATE_BONKCHOY_PUNCHING)
    {
        if (aCurrentFrame >= 4)
        {
            ...
            {
                if (
                    ((aZombie->GetZombieRect().mX < GetPlantRect().mX) && (mBonkchoyFlipped == true)) ||
                    ((aZombie->GetZombieRect().mX >= GetPlantRect().mX) && (mBonkchoyFlipped == false))
                    )
                {
                    if (!mBonkchoyFlipped)
                    {
            ...
            {
                if (
                    ((aGridItem->GetPVZ2GraveRect().mX < GetPlantRect().mX) && (mBonkchoyFlipped == true)) ||
                    ((aGridItem->GetPVZ2GraveRect().mX >= GetPlantRect().mX) && (mBonkchoyFlipped == false))
                    )
                {
                    aGridItem->TakeDamage(aDamage, 0U);
                    mApp->PlayFoley(FoleyType::FOLEY_BONK);
                    mBonkChoyPunchCD -= 0.25f;
                    mBonkChoyPunchCD = ClampFloat(mBonkChoyPunchCD, 22.0f, 66.0f);
                }
    ...
    else if (mState == PlantState::STATE_BONKCHOY_PUNCH_LANDED)
    {
        if (mStateCountdown <= 0)
        {
            if (!aZombie && !aGridItem)
            {
                mBonkchoyFlipped = false;
            }
            mStateCountdown = mBonkchoyUppercut ? 2500 : 500;
            mBonkchoyUppercut = false;
            mState = PlantState::STATE_READY;
            PlayIdleAnim(aBodyReanim->mDefinition->mFPS);
        }
...
void Plant::UpdateChomper()
{
    ...
    if (mState == PlantState::STATE_READY)
    {
        if (FindTargetZombie(mRow, PlantWeapon::WEAPON_PRIMARY) || FindTargetGridItem(mRow, PlantWeapon::WEAPON_PRIMARY))
        {
        ...
        if (mStateCountdown == 0)
        {
            ...
            if (doBite)
            {
                ...
                if (mSide == 1)
                {
                    ...
                    {
                        aZombie->TakeDamage(150, 0U);
                    }
                    if (mBonkChoyPunchCD <= 0.0f)
                    {
                        mState = PlantState::STATE_CHOMPER_BITING_GOT_ONE;
                        ReanimatorTrackInstance* aTrackInstance = aBodyReanim->GetTrackInstanceByName("Zombie_outerarm_lower");
                        aTrackInstance->mImageOverride = IMAGE_BLANK;

                        aTrackInstance = aBodyReanim->GetTrackInstanceByName("Zombie_outerarm_hand");
                        aTrackInstance->mImageOverride = IMAGE_BLANK;
...
void Plant::UpdateBowling()
{
    ...
    {
        float aPrevRoofY = mBoard->GetPosYBasedOnRow(aPrevBowlingX, mRow);
        float aCurRoofY = mBoard->GetPosYBasedOnRow(mX, mRow);
        mY += aCurRoofY - aPrevRoofY;
    }
    ...
    float aTargetGridY = mBoard->StageHasRoof() ? mBoard->GetPosYBasedOnRow(mX, mRow) : mBoard->GridToPixelY(0, mRow);
    float aDistToGrid = aTargetGridY - mY;
    ...
    if (aZombie)
    {
        ...
        else if ((mSeedType == SeedType::SEED_WALLNUT && mSide == 1))
        {
            aZombie->KnockBackZombie(1, 6.0f, 20);
            aZombie->ApplyStun(100);
            aZombie->TakeDamage(200 + mLaunchCounter * 40, 0U);
            aShakeX = 1;
            aShakeY = -1;
        }
...
void Plant::UpdateAbilities()
{
    ...
    else if (mSeedType == SeedType::SEED_HYPNOSHROOM && mSide == 1)                                         UpdateHypnoShroom();
    else if (mSeedType == SeedType::SEED_BONKCHOY)                                              UpdateBonkchoy();
    else if (mSeedType == SeedType::SEED_LASERBEAN)                                             UpdateLaserBean();
    else if (mSeedType == SeedType::SEED_SEASHROOM)                                             UpdateGoldBloom();
    else if (mSeedType == SeedType::SEED_GARLIC)                                             UpdateGarlic();
    else if (mSeedType == SeedType::SEED_PUFFSHROOM && mSide == 1)                                             UpdatePuffShroom();
    else if (mSeedType == SeedType::SEED_SAKURA)                                             UpdateSakura();
...
bool Plant::IsUpgradableTo(SeedType theUpgradedType)
{
    ...
    if (theUpgradedType == SeedType::SEED_SLINGPEA && mSeedType == SeedType::SEED_THREEPEATER)
    {
        return true;
    }
...
void Plant::UpdateReanimColor()
{
    ...
    else if (mSeedType == SeedType::SEED_PUFFSHROOM && mSide == 1)
    {
        aColorOverride = Color(255, 255, 255, (255 - (155 * ((6000.0f - mStateCountdown) / 6000.0f))));
        if (mBonkchoyUppercut)
            aColorOverride = Color(255, 255, 255, 0);
    }
    ...
    else if (mState == PlantState::STATE_GRAVEBUSTER_EATING && mSide == 1)
    {
        aColorOverride = Color(
            255,
            255,
            255,
            255 - TodAnimateCurveFloat(400, 0, mStateCountdown, 0.0f, 125.0f, TodCurves::CURVE_LINEAR)
        );
    }
    else if (mSeedType == SeedType::SEED_LASERBEAN)
    {
    ...
    else if (mBeghouledFlashCountdown > 0)
    {
        ...
        anAlpha = TodAnimateCurve(anInterval, 0, mBeghouledFlashCountdown % anInterval, 0, 128, TodCurves::CURVE_BOUNCE);
...
void Plant::UpdateReanim()
{
    ...
    if (mSeedType == SeedType::SEED_SQUASH && mSide == 1)
    {
        aScaleX = 0.25f;
        aScaleY = 0.25f;
        aOffsetX += 30.0f;
...
void Plant::UpdateShooting()
{
    ...
    {
        int aRenderPosition = Board::MakeRenderOrder(RenderLayer::RENDER_LAYER_PARTICLE, mRow, 0);
        TodParticleSystem* aParticleSystem = AddAttachedParticle(mX + 85, mY + 31, aRenderPosition, ParticleEffect::PARTICLE_FUMECLOUD);
        if (mSide == 1)
            aParticleSystem->mFieldPositionXScale = 0.325f;
    }
    if (mSeedType == SeedType::SEED_LASERBEAN && mShootingCounter == 3)
    {
        int aRenderPosition = Board::MakeRenderOrder(RenderLayer::RENDER_LAYER_PARTICLE, mRow, 0);
        TodParticleSystem* aParticleSystem = AddAttachedParticle(mX + 57, mY + 35 - (2.8f * mPlantCol) - 18, aRenderPosition, ParticleEffect::PARTICLE_LASER);
    ...
    else if (mSeedType == SeedType::SEED_SLINGPEA && mShootingCounter == 1)
    {
        int maxRows = mBoard->StageHas6Rows() ? 6 : 5;
        int shootCounter = maxRows;
        while (shootCounter > 0)
...
void Plant::DrawChain(Sexy::Graphics* g)
{

    if (mSeedType == SeedType::SEED_HYPNOSHROOM && mState == PlantState::STATE_READY) {
        if (!mBoard->ZombieTryToGet(mTargetZombieID))
            return;
        Zombie* aZombie = mBoard->ZombieTryToGet(mTargetZombieID);
        Image* aImage = IMAGE_LASERGLOW;
        bool draw = true;

        //endpoint 
        float tarX = aZombie->mPosX + aZombie->mWidth / 2;
        float tarY = aZombie->mPosY + aZombie->mHeight / 2;
        //float tarX = mBoard->mPrevMouseX + 10;
        //float tarY = mBoard->mPrevMouseY + 10;
        ...
        float dist = aImage->GetCelHeight() - 4.0f;
        ...
        while (draw) {
            ...
            if (length < dist) {
                ...
                Rect aSrcRect = Rect(0, 0, aImage->mWidth, aImage->mHeight);
                float aOffsetX = mX + 40 + dx;
                float aOffsetY = mY + 40 + dy;

                //rotation
                float rotation = (float)(atan2(tarY - aOffsetY, tarX - aOffsetX) - 1.57f);
...
void Plant::DrawSeedType(Graphics* g, SeedType theSeedType, SeedType theImitaterType, DrawVariation theDrawVariation, float thePosX, float thePosY)
{
    ...
    if (aSeedType == SeedType::SEED_SQUASH && GetPlantSide(aSeedType) == 1)
    {
        aSeedG.mScaleX = 0.25f;
        aSeedG.mScaleY = 0.25f;
        aOffsetX += 30.0f;
        aOffsetY += 60.0f;
    }
...
void Plant::MouseDown(int x, int y, int theClickCount)
{
    ...
    if (mState == PlantState::STATE_SAKURA_PREPARE)
    {
        Projectile* aProjectile = nullptr;
        while (mBoard->IterateProjectiles(aProjectile))
        {
...
void Plant::BlowAwayFliers(int theX, int theRow)
{
    ...
    while (mBoard->IterateZombies(aZombie))
    {
        ...
        {
            Rect aZombieRect = aZombie->GetZombieRect();
            if (aZombie->IsFlying() || aZombie->mZombiePhase == ZombiePhase::PHASE_IMP_GETTING_THROWN)
            {
    ...
    mBoard->mFogBlownCountDown += 1000;
}
void Plant::SlowAllZombies()
{
    int aBloverCount = 0;
    Plant* aPlant = nullptr;
    while (mBoard->IteratePlants(aPlant))
    {
        if (aPlant->mSeedType == SeedType::SEED_BLOVER)
        {
            aBloverCount++;
        }
    }
    ...
    while (mBoard->IterateZombies(aZombie))
    {
        if (!aZombie->IsDeadOrDying())
        {
            aZombie->mSlowCounter += 250 + 25 * (aBloverCount - 1);
            if (aZombie->IsFlying() || aZombie->mZombiePhase == ZombiePhase::PHASE_IMP_GETTING_THROWN)
            {
                aZombie->mBlowCounter += 50 + 10 * (aBloverCount - 1);
            }
            aZombie->UpdateAnimSpeed();
        }
    }
...
void Plant::DoSpecial()
{
    ...
    case SeedType::SEED_INSTANT_COFFEE:
    {
        ...
        else if (mSide == 1)
        {
            if (aPlant && !aPlant->mIsAsleep)
            {
                aPlant->mSpeedCounter = 3750;
                aPlant->mLaunchCounter = min(500, mLaunchCounter);
                aPlant->mBeghouledFlashCountdown = 3750;
            }
        }
    ...
    case SeedType::SEED_SEASHROOM:
    {
        ...
        mState = PlantState::STATE_DOINGSPECIAL;
        mStateCountdown = 50;
        PlayBodyReanim("anim_produce", ReanimLoopType::REANIM_PLAY_ONCE_AND_HOLD, 20, 14.0f);
    }
    }
}
...
void Plant::Fire(Zombie* theTargetZombie, int theRow, PlantWeapon thePlantWeapon)
{
    ...
    case SeedType::SEED_LEFTPEATER:
        ...
        break;
    case SeedType::SEED_SNOWPEA:
        aProjectileType = ProjectileType::PROJECTILE_PIERCE_SNOW;
        break;
    case SeedType::SEED_PUFFSHROOM:
    case SeedType::SEED_SCAREDYSHROOM:
    ...
    aProjectile->mPlantOwnerID = (PlantID)mBoard->mPlants.DataArrayGetID(this);
    aProjectile->mSavedCountdown = mStateCountdown;

    if (mSeedType == SeedType::SEED_CABBAGEPULT ||
        mSeedType == SeedType::SEED_KERNELPULT ||
        mSeedType == SeedType::SEED_MELONPULT ||
        mSeedType == SeedType::SEED_SPORESHROOM ||
        mSeedType == SeedType::SEED_WINTERMELON)
    {
        ...
        else
        {
            ...
            {
                Rect aGridItemRect = aGridItem->GetPVZ2GraveRect();
                aRangeX = aGridItemRect.mX + aGridItemRect.mWidth / 2 - aOriginX - 30.0f;
                aRangeY = aGridItemRect.mY - aOriginY;
        ...
        )
    {
        ...
        if (theTargetZombie)
        {
            ...
            //float rowDiff = (mRow - theTargetZombie->mRow) * 80.0f;
            //aRangeY = aZombieRect.mY - aOriginY + rowDiff / 120.0f + RandRangeFloat(-7.f, 7.f);
            //aRangeZ = aZombieRect.mY - aOriginY + rowDiff;
            float rowOffset = (theTargetZombie->mRow - mRow) * 80.0f;
            aRangeY = rowOffset;
            if (rowOffset != 0.0f)
            {
                aRangeY += RandRangeFloat(-7.0f, 7.0f);
            }
            aRangeZ = aZombieRect.mY - aOriginY - rowOffset;
            if (theTargetZombie->mZombiePhase == ZombiePhase::PHASE_DOLPHIN_RIDING)
            {
                aRangeX -= 60.0f;
            }
            ...
            if (theTargetZombie->mZombieType == ZombieType::ZOMBIE_BOSS)
            {
                aRangeY = mBoard->GridToPixelY(8, 2) - aOriginY;
                aRangeX -= 80.0f;
        ...
        {
            aRangeX = (aRangeX >= 0.0f) ? 40.0f : -40.0f;
        }
        if (aRangeX < 0.0f)
        {
            aRangeX += 10.0f;
        ...
        aProjectile->mAccZ = 0.115f;
        //aProjectile->mShadowY = mBoard->GridToPixelY(mPlantCol, mRow) + 67.0f;;
        int aGridX = mBoard->PixelToGridXKeepOnBoard((int)aProjectile->mPosX, (int)aProjectile->mPosY);
        aProjectile->mShadowY = mBoard->GridToPixelY(aGridX, mRow) + 67.0f;
    }
    else if (mSeedType == SeedType::SEED_THREEPEATER)
    {
        if (theRow < mRow)
...
GridItem* Plant::FindTargetGridItem(int theRow, PlantWeapon thePlantWeapon)
{
    ...
    while (mBoard->IterateGridItems(aGridItem))
    {
        ...
        {
            if (aGridItem /*&& !TestBit((unsigned int)mDamageRangeFlags, (int)DamageRangeFlags::DAMAGES_FLYING)*/)
            {
                int aRowDeviation = aGridItem->mGridY - theRow;
                if (mSeedType == SeedType::SEED_GLOOMSHROOM)
                {
                    if (aRowDeviation < -1 || aRowDeviation > 1)
                    {
...
void Plant::Die()
{
    if (IsOnBoard() && mSeedType == SeedType::SEED_TANGLEKELP && !mBonkchoyUppercut)
    {
        Zombie* aZombie = mBoard->ZombieTryToGet(mTargetZombieID);
        if (aZombie)
        {
    ...
    //while (mBoard->IteratePlants(aPlant))
    //{
    //    if (aPlant->mSeedType == SeedType::SEED_GRAVEBUSTER && aPlant->mSide == 1 && aPlant->mGraveBusterGetPlant == this)
    //    {
    //        aPlant->Die();
    //        bool aTest = mBoard->CanPlantAt(mPlantCol, mRow, mSeedType) == PLANTING_OK;
    //        if (aTest)
    //        {
    //            mBoard->AddPlant(mPlantCol, mRow, mSeedType, SeedType::SEED_NONE);
    //            TodParticleSystem* aParticleSystem = mApp->AddTodParticle(mX + 40, mY + 40, (int)RenderLayer::RENDER_LAYER_TOP, ParticleEffect::PARTICLE_IMITATER_MORPH);
    //        }
    //    }
    //}
...
int Plant::GetCost(SeedType theSeedType, SeedType theImitaterType)
{
    ...
    SeedType aActualType = (theSeedType == SeedType::SEED_IMITATER && theImitaterType != SeedType::SEED_NONE) ? theImitaterType : theSeedType;
    if (aActualType == SeedType::SEED_SQUASH && GetPlantSide(aActualType) == 1)
        return 0;
    else if (aActualType == SeedType::SEED_WALLNUT && GetPlantSide(aActualType) == 1)
        return 75;
    else if (aActualType == SeedType::SEED_FUMESHROOM && GetPlantSide(aActualType) == 1)
        return 125;
    else if (aActualType == SeedType::SEED_GRAVEBUSTER && GetPlantSide(aActualType) == 1)
        return 125;
    else if (aActualType == SeedType::SEED_POTATOMINE && GetPlantSide(aActualType) == 1)
        return 75;
    else if (aActualType == SeedType::SEED_CHOMPER && GetPlantSide(aActualType) == 1)
        return 200;
...
int Plant::GetRefreshTime(SeedType theSeedType, SeedType theImitaterType)
{
    ...
    SeedType aActualType = (theSeedType == SeedType::SEED_IMITATER && theImitaterType != SeedType::SEED_NONE) ? theImitaterType : theSeedType;
    const PlantDefinition& aPlantDef = GetPlantDefinition(aActualType);
    if (aActualType == SeedType::SEED_PUFFSHROOM && GetPlantSide(aActualType) == 1)
        return 1000;
    else if (aActualType == SeedType::SEED_SQUASH && GetPlantSide(aActualType) == 1)
        return 750;
    else if (aActualType == SeedType::SEED_WALLNUT && GetPlantSide(aActualType) == 1)
        return 2000;
    else if (aActualType == SeedType::SEED_FUMESHROOM && GetPlantSide(aActualType) == 1)
    ...
    //{
    //    const PlantDefinition& aPlantDef = GetPlantDefinition(theImitaterType);
    //    if (theImitaterType == SeedType::SEED_PUFFSHROOM && GetPlantSide(theImitaterType) == 1)
    //        return 1000;
    //    else if (theImitaterType == SeedType::SEED_SQUASH && GetPlantSide(theImitaterType) == 1)
    //        return 750;
    //    else if (theImitaterType == SeedType::SEED_WALLNUT && GetPlantSide(theImitaterType) == 1)
    //        return 2000;
    //    else if (theImitaterType == SeedType::SEED_FUMESHROOM && GetPlantSide(theImitaterType) == 1)
    //        return 1500;
    //    return aPlantDef.mRefreshTime;
    //}
    //else
    ...
    //        return 2000;
    //    else if (theSeedType == SeedType::SEED_FUMESHROOM && GetPlantSide(theSeedType) == 1)
    //        return 1500;
    //    return aPlantDef.mRefreshTime;
    //}
...
{
    return
        (theSeedtype == SeedType::SEED_PUFFSHROOM && GetPlantSide(theSeedtype) == 0) ||
...
bool Plant::IsUpgrade(SeedType theSeedtype)
{
    return 
        ...
        theSeedtype == SeedType::SEED_SLINGPEA || 
...
Rect Plant::GetPlantAttackRect(PlantWeapon thePlantWeapon)
{
    ...
    {
        aRect = Rect(-80 + BOARD_ADDITIONAL_WIDTH, mY, BOARD_WIDTH, mHeight);
    }
    ...
    case SeedType::SEED_PUFFSHROOM:     aRect = Rect(mX + 60, mY, 230, mHeight);               break;
    //case SeedType::SEED_SEASHROOM:      aRect = Rect(mX + 60,       mY,             230,                mHeight);               break;
    case SeedType::SEED_FUMESHROOM:   
        if (mSide == 1)
        {
            aRect = Rect(mX + 60, mY, 120, mHeight);
        }
        else
        {
        ...
        break;
    case SeedType::SEED_GARLIC:         aRect = Rect(mX - 40, mY - 80, 160, 240);                   break;
    ...
    case SeedType::SEED_SLINGPEA:    aRect = Rect(-BOARD_WIDTH, mY, BOARD_WIDTH * 2, mHeight);               break;
...
int Plant::CalculateLaneZombieHealth(int theRow)
{
    ...
    while (mBoard->IterateGridItems(aGridItem))
    {
        if (aGridItem->mGridY == theRow/* && !TestBit(aDamageRangeFlags, (int)DamageRangeFlags::DAMAGES_FLYING)*/)
        {
            if (aGridItem->mGridItemType == GridItemType::GRIDITEM_PVZ2_GRAVE)
            {
                aTotalHealth += aGridItem->mPVZ2GraveHealth;
            }
        }
    }
